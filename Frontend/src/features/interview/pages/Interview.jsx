    ...
    if (error) {
        return (
            <main className='loading-screen'>
                ...
                <p style={{ marginTop: '1rem', color: '#ccc' }}>{error}</p>
                <p style={{ marginTop: '2rem', fontSize: '0.9rem', color: '#999' }}>Please try again later.</p>
            </main>
        )
    }
            ...
            <div className='interview-layout'>
                ...
                <aside className='interview-sidebar'>
                    ...
                    <div className='match-score'>
                        ...
                        {/* Text info — shown beside the ring on tablet/mobile horizontal layout */}
                        <div className='match-score__info'>
                            <span className='match-score__info-label'>Match Score</span>
